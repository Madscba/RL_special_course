...
from hand_in.environment.gym_environment import get_envs, get_envs_vec
...
if __name__ == "__main__":
    ...
    # e, state = get_envs_vec(env_id=p.args.env_name, num_envs=p.args.n_env)
