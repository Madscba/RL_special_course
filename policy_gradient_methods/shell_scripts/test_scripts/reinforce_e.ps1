...
& $python_executable1 C:\Users\Mads-\Documents\universitet\4_sem\RL\RL_special_course\policy_gradient_methods\main.py --seed 3 --n_episodes 2 --n_environments 2 --entropy True --learning_algorithm "REINFORCE" --visualize False
